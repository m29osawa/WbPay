	...
	public partial class Form1 : Form
	{
		...
		private void button4_Click(object sender, EventArgs e) {
			...
			try{
				...
				request.PayType = WbCPSPayType.AutoDetect;
				request.Amount = 10000;
				request.ReceiptNo = "10002220003";
				//request.ReceiptNo = "012345678901234567890123456789012";
				//request.UserCode = "251234567890123456789012";	//AlipayConnect
				//request.UserCode = "9000010012345678";	//楽天Pay
				request.UserCode = "9000000212345678901234";	//d払い
				//request.UserCode = "900081811234567890123456";	//PayPay
				//request.UserCode = "3158990012345678901";	//メルペイ
				//request.UserCode = "3158992112345678901";	//auペイ
				//request.UserCode = "9000000312345678";	//J-Coin
				//request.UserCode = "9000000012345678901";	//LINEPay
				//request.UserCode = "111234567890123456";	//Wechat
				//request.UserCode = "9000909012345678901234";	//QuoカードPay
				//request.UserCode = "3158993112345678901";	//ゆうちょPay
				//request.UserCode = "90000010123456789012";	//りそなウォレット
		...
		private void button7_Click(object sender, EventArgs e) {
			...
			try{
				...
				Console.WriteLine("Confirm not supported");
		...
		void OnCompleteEvent(WbCPSRequestType type,Object obj)
		{
			...
			//}
				...
				Console.WriteLine("Exceptin in OnCompleteEvent : {0}",ex);
			}
		}
		//int count = 0;
